...
list_of_favorite_foods = ["pizza", "burger", "grapes", "fries", "tacos"]
print(list_of_favorite_foods)
# # Print the second and last item.
print(list_of_favorite_foods[3:])
# # Add a new item using .append().
list_of_favorite_foods.append("flautas")
print(list_of_favorite_foods)
# # Remove the first item using .pop(0).
popped_item = list_of_favorite_foods.pop()
print(list_of_favorite_foods)
